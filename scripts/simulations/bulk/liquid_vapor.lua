-- Simulate a bulk liquid-vapor slab.
...
local function read_sample(args)
...
function main(args)
    ...
    -- Write thermodynamic variables to H5MD.
...
function define_args(parser)
    ...
    parser:add_argument("resonance_frequency", {
        type = "number",
        default = 5,
        help = "Nosé-Hoover resonance frequency"
    })
    ...
    sampling:add_argument("structure", {
        type = "integer",
        default = 1000,
        help = "for density modes and static structure factors"
    })
