-- Generate an amorphous particle wall.
...
function main(args)
    ...
    local group_all = mdsim.particle_groups.all({
        particle = particle_all
    })
    ...
    particle_all.data["species"] = utility.repeat_element(
        1,
        particle_all.nparticle
    )
...
function define_args(parser)
    ...
    parser:add_argument("obstacle_density", {
        type = "number",
        default = 0.7,
