...
function main(args)
    ...
    if interval > 0 or args.sampling.correlation > 0 then
        ...
        slab_analysis.slab_analysis(args.slab.num_slabs, args.slab.axis, particle_fluid, wavevectors, pore_length, file, box, args)
    end
...
function define_args(parser)
    ...
    slab:add_argument("num_slabs", {type = "integer", default = 40, help = "number of slabs"})
